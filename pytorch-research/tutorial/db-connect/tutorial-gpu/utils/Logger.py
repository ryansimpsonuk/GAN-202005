...
class Logger:
    ...
    def __init__(self, model_name, data_name, data_path_root, exp_name):
        ...
        self.logging_dir = f'{data_path_root}/runs/{exp_name}/'
        ...
        print(f'image save location: {self.data_path_root}/data/images/{self.data_subdir}')
        ...
        self.writer = SummaryWriter(log_dir=self.logging_dir, comment=self.comment)
